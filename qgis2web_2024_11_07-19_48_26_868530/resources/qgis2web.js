...
map.getView().fit([8427085.706118, 1159659.643882, 8584685.074913, 1258985.120792], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">barathaPuzha</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (29 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this is a map of barathapuzha';
            }
